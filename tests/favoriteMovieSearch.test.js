...
describe('Searching movies', () => {
  ...
  describe('When query is not empty', () => {
    ...
    // Dengan suksesnya tes "should show - when the movie returned does not contain a title" , kita bisa menghapus semua tes yang melibatkan _showFoundMovies.
    ...
    // Di dalam tes. Perhatikan kita menggunakan fit. Jadi, hanya tes ini saja yang berjalan.
    it('should show the name of the movies found by Favorite Movies', (done) => {
      ...
      // expect(document.querySelector('.movie').length).toEqual(3);
    });
